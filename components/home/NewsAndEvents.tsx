    ...
    <section id="news" className="bg-gradient-to-br from-black via-[#081a19] to-black py-12 lg:py-16 border-b border-white/10 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <Link
            href="/news"
            className="text-xs font-bold text-[#eaf6f6] uppercase tracking-wider hover:text-amber-300 transition-colors flex items-center space-x-1 self-start sm:self-auto"
          >
