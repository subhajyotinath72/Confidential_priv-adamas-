...
export const CustomMap: React.FC = () => {
  ...
  return (
    <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden shadow-sm p-4 sm:p-6 relative text-[#eaf6f6]">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-white/10 mb-4">
        <div>
          ...
          <h3 className="text-base sm:text-lg font-bold text-[#eaf6f6] flex items-center">
        ...
        <a
          ...
          className="inline-flex items-center text-xs font-bold px-3.5 py-2 rounded-xl bg-white/10 text-[#eaf6f6] border border-white/20 hover:bg-white/20 transition-colors shadow-2xs self-start sm:self-auto"
        >
      ...
      <div className="relative w-full h-80 sm:h-96 rounded-xl bg-slate-900 border border-white/10 overflow-hidden shadow-inner">
        <iframe
      ...
      <div className="mt-4 pt-4 border-t border-white/10 text-xs text-[#eaf6f6]/70 flex flex-col sm:flex-row sm:items-center justify-between gap-2">
        <div className="flex items-center space-x-2">
          <MapPin className="w-4 h-4 text-amber-400 flex-shrink-0" />
          <span>Barasat–Barrackpore Road, Barbaria, P.O Jagannathpur, Kolkata – 700126, West Bengal</span>
        </div>
        <div className="flex items-center space-x-1 text-teal-300 font-semibold">
