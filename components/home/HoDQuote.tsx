      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-5">
            <div className="bg-white/5 p-4 sm:p-5 rounded-2xl border border-white/10 shadow-sm">
              <div className="relative overflow-hidden rounded-xl h-80 sm:h-96 bg-slate-900 border border-white/10">
                <img
                ...
                <div className="absolute bottom-3 left-3">
                  <span className="px-3 py-1 bg-[#103E3B] text-[9px] font-bold text-[#eaf6f6] uppercase tracking-widest rounded border border-white/20">
                    OFFICE OF THE HOD
                  </span>
                </div>
              </div>
              ...
              <div className="mt-4 space-y-1">
                ...
                <p className="text-xs text-[#eaf6f6]/80 font-sans">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            {/* Title */}
            <h2 className="text-3xl sm:text-5xl font-serif font-semibold text-[#eaf6f6] tracking-tight leading-[1.15]">
              Welcome to Biomedical Engineering at Adamas University
            </h2>

            {/* Body Text */}
            <p className="text-sm sm:text-base text-[#eaf6f6]/90 leading-relaxed font-sans">
            ...
            <p className="text-sm sm:text-base text-[#eaf6f6]/75 leading-relaxed font-sans">
            ...
            <div className="pt-4 border-t border-white/10">
              <div>
                <div className="font-serif font-bold italic text-[#eaf6f6] text-lg">
                  Dr. Semanti Chakraborty
                </div>
                <div className="text-[11px] text-[#eaf6f6]/60 uppercase tracking-wider">
