                ...
                {labGridItems.map((lab, idx) => (
                  ...
                  >
                    ...
                    <div className="absolute top-2 right-2 opacity-80 group-hover:opacity-100 transition-opacity">
                      <span className="inline-flex items-center px-1.5 py-0.5 rounded bg-black/60 text-[8px] font-bold text-emerald-300 border border-white/10 uppercase backdrop-blur-sm">
