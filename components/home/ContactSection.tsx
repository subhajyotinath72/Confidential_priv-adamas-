...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section id="contact" className="bg-[#F8F5EE] py-12 lg:py-16 border-b border-[#E2DDD3]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="space-y-3 text-xs sm:text-sm text-slate-700 font-sans leading-relaxed">
              <div>
                <strong className="text-[#1B365D]">Location:</strong> Floor 3, School of Engineering, Adamas University Campus, Barasat, Kolkata 700126, India.
              </div>
              <div>
                <strong className="text-[#1B365D]">Email:</strong>{" "}
                <a href="mailto:biomedical.dept@adamasuniversity.ac.in" className="hover:underline text-[#1B365D] font-medium">
                  biomedical.dept@adamasuniversity.ac.in
                </a>
              </div>
              <div>
                <strong className="text-[#1B365D]">Telephone:</strong> +91 33 6811 4500 (Ext. 248)
              </div>
              <div>
                <strong className="text-[#1B365D]">Hours:</strong> Monday – Friday, 09:30 AM – 05:30 PM IST
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-5">
            <div className="bg-[#EFECE6] p-6 sm:p-8 rounded-2xl border border-[#E2DDD3] shadow-xs space-y-5">
